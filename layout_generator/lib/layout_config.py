...
parser.add_argument('--coco_min_area', type=float, default=0.0016, help='threshold for the box size')
...
# Text encoder
parser.add_argument('--n_src_hidden',  type=int, default=768)
parser.add_argument('--n_tgt_hidden',  type=int, default=768)
parser.add_argument('--bidirectional', type=str2bool, default=False)
parser.add_argument('--n_rnn_layers',  type=int, default=1)
parser.add_argument('--rnn_cell', type=str, default='GRU')
parser.add_argument('--n_embed',  type=int, default=768, help='GloVec dimension')
...
parser.add_argument('--log_per_steps', type=int, default=20)
...
parser.add_argument('--bert', type=str2bool, default=False)
parser.add_argument('--reduction', type=str2bool, default=False)
parser.add_argument('--mse', type=str2bool, default=True)
parser.add_argument('--warmup',  type=float, default=0.1, help='epsilon')
